        ...
        <div className="row justify-content-center p-2 border_bottom">
            <nav className="col-12 row align-items-center">
                ...
                <ul className="navbar-list d-md-flex d-none flex-row col-6 m-0 p-0">
                    ...
                    <li>
                    <button className="btn nav-btn">Win</button>
                        <div className='d-none flex-column expand-nav '>
                    ...
                    <li>
                    <button className="btn nav-btn">NFT</button>
                        <div className='d-none flex-column expand-nav '>
                            <a>Overview</a>
                            <a>Collection</a>
                            <a>Activity</a>          
                    ...
                    <button className="btn nav-btn">...</button>
                        <div className='d-none flex-column expand-nav '>
                            ...
                            <a>Collection</a>
                            <a>Voting</a>    
                            <a className='border-a'>Leaderbord</a>      
                            <a  className='d-flex flex-row justify-content-between align-items-center text-dark'>
                                <a>Blogs</a>
                                <BiExit  className='fs-4 '/>
                            </a>
